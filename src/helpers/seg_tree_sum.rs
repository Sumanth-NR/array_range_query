...
/// assert_eq!(tree.query(..), 22); // Updated sum: 1 + 2 + 10 + 4 + 5
/// ```
...
mod tests {
    ...
    fn test_sum_edge_cases() {
        ...
        assert_eq!(tree.query(..0), 0); // Empty range at start
        assert_eq!(tree.query(8..), 0); // Empty range at end
    }
    ...
    fn test_sum_large_tree() {
        ...
        assert_eq!(tree.query(..), 500000); // 500500 - 500 = 500000
        assert_eq!(tree.query(..500), 124750); // 125250 - 500 = 124750
    }
    ...
    fn test_sum_new_empty_tree() {
        ...
        assert_eq!(tree.query(..2), 10); // 0 + 10
    }
}
